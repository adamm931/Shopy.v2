...
export const AddCategory = (name: string, description: string): AddCategoryRequest => ({
    Payload: {
        Name: name,
        Description: description
    },
...
export const EditCategory = (externalId: string, name: string, description: string): EditCategoryRequest => ({
    Payload: {
        ExternalId: externalId,
        Name: name,
        Description: description
