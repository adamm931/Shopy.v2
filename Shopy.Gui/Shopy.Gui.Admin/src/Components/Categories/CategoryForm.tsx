...
class CategoryForm extends React.Component<Props, CategoryFormState> {
    ...
    onSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (this.props.Type === FormType.ADD) {
            this.props.Add(this.state.Name, this.state.Description)
        }
            ...
            this.props.Edit(this.props.ExternalId, this.state.Name, this.state.Description)
        }
            ...
            <div>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="mb-3 col-md-6">
                        ...
                        <textarea name="description" value={this.state.Description} onChange={this.onDescriptionChange} className="form-control" />
                    </div>
...
const mapDispatchToProps = (dispatch: any): CategoryFormDispatch => ({
    Add: (name: string, description: string) => dispatch(RequestFactory.AddCategory(name, description)),
    Edit: (externalId: string, name: string, description: string) => dispatch(RequestFactory.EditCategory(externalId, name, description))
})
